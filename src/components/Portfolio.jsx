    ...
    const portfolios = [
        {
            id: 1,
            src: Chonk,
            description: "C.H.O.N.K (Convolutional Heftiness Observer for Notable Kitties) - A sophisticated deep learning project leveraging computer vision for cat classification. Engineered automated data collection using DDG API with 2400+ images, developed robust ETL pipeline, and implemented a continuous learning system with TensorFlow and ResNet50. Features include data validation, multi-stage checks, and user feedback integration for ongoing model improvement.",
            link: "https://github.com/ethan2000liu/-C.H.O.N.K",
            showButton: true
        },
        {
            id: 2,
